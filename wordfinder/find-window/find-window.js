...
//this values array is for history search (incomplete)
var values = ["-","-","-","-","-"];
...
class App{
  ...
  setupSearchOptions(){
    ...
    //-------------------------------------------------------------------------
    //Fast Saved Function
    //Save into button for Fast Saved
    ...
    //-------------------------------------------------------------------------
    //toogle for Fast Saved Function
    ...
    //-------------------------------------------------------------------------
    //toogle for Pre-Setting Keyword Function
 ...
 //-------------------------------------------------------------------------
 //Save input into array, first in first out method
 save(){
   values.shift();
